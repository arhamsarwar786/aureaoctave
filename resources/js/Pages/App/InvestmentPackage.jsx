...
const dummyPackages = [
    ...
    { id: 3, name: "VanEck Treasury Fund", code: "VBIL", company: "VANECK", image: "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3", description: "Earn stable yield with a treasury-backed fund designed to maintain $1 token value while distributing daily yield to investors.", min_investment: "$100k – $1M", expense_ratio: "0.20%", sec_yield: "3.48%", liquidity: "Instant", tags: ["Yield Daily", "U.S. Treasuries"], },
     { id: 4, name: "Mantle Index Four Fund", code: "MI4", company: "MANTLE", image: "https://images.unsplash.com/photo-1621504450181-5d356f61d307", description: "Diversified crypto exposure through a structured index fund designed for institutional-grade blockchain portfolio strategies.", min_investment: "$500", expense_ratio: "0.15%", sec_yield: "5.20%", liquidity: "Daily", tags: ["Index", "Crypto"], },
      { id: 5, name: "Apollo Diversified Credit Fund", code: "ACRED", company: "SECURITIZE CAPITAL · APOLLO", image: "https://images.unsplash.com/photo-1640161704729-cbe966a08476", description: "Institutional diversified credit exposure across multiple asset classes with strong yield potential.", min_investment: "$1,000", expense_ratio: "1.50%", sec_yield: "7.10%", liquidity: "Monthly", tags: ["Diversified", "Credit"], },
