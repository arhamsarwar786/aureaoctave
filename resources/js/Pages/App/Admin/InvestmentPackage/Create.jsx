...
export default function CreateInvestmentPackage({ auth }) {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        post(route("investment-package.store"));
    };
        ...
        <AuthenticatedLayout user={auth.user} title="Add Investment Package">
            <div className="p-4 sm:p-8 bg-white shadow rounded-lg space-y-5">
                <header className="relative mb-8">
                    <h1 className="font-bold text-2xl">Investment Package</h1>
                    <p>Add new investment package details.</p>
                </header>
                <main className="">
