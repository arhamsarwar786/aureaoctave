...
export default function NavLink({
    ...
    return (
        <Link
            {...props}
            className={
                "relative inline-flex max-xl:block items-center p-1 pl-4 rounded text-[16px] leading-5 transition duration-150 ease-in-out focus:outline-none w-full gap-3 " +
                (active
