 ...
 */const x=u("CheckCheck",[["path",{d:"M18 6 7 17l-5-5",key:"116fxf"}],["path",{d:"m22 10-7.5 7.5L13 16",key:"ke71qq"}]]);function B({auth:i}){const{data:a,setData:s,errors:r,post:o,processing:l}=m({amount:"",transaction_type:"debit",address:""}),n=t=>{t.preventDefault(),o(route("withdrawal.store"))};return e.jsx(h,{user:i.user,title:"Withdrawal",children:e.jsx("div",{className:"p-6 lg:p-10",children:e.jsxs("section",{className:"grid grid-cols-1 lg:grid-cols-2 gap-10",children:[e.jsxs("div",{className:`bg-gradient-to-br from-[#0F1720] to-[#0B1117]
                            ...
                            p-8 space-y-8`,children:[e.jsxs("header",{children:[e.jsx("h1",{className:"text-3xl font-bold text-white",children:"Withdraw Funds"}),e.jsx("p",{className:"text-slate-400 mt-2",children:"Enter your withdrawal details below."})]}),e.jsxs("form",{onSubmit:n,className:"space-y-8",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-sm text-slate-400",children:"Withdrawal Amount (USD)"}),e.jsx("input",{type:"text",value:a.amount,onChange:t=>s("amount",t.target.value),required:!0,placeholder:"Enter amount",className:`mt-2 w-full bg-[#0B141B]
                                   ...
                                   hover:scale-[1.02]
                                   hover:shadow-lg
                                   transition-all duration-300`,children:l?"Processing...":"Submit Withdrawal"})]})]})]})})})}export{B as default};
